...
<html>
  ...
  <head>
    <meta charset="UTF-8">
    <title>授权信息》授权列表--Authorization_list_other.jsp</title>
      ...
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
          ...
          <input class="layui-input" placeholder="截止日期" name="end_time"   id="end_time"  autocomplete="off"   title="创建case日期">
           ...
           <input type="hidden"    name="userName" id="userName"   placeholder="用户名称" autocomplete="off" class="layui-input" value="${login_user }">
...
<!--               <button type="button"  onclick="test()" value="测试">测试</button> -->
   ...
   <a class="layui-btn layui-btn-xs" style="margin-left: 2px;margin-right: 2px;"  lay-event="edit">详细</a>
...
// 			  {type: 'checkbox', fixed: 'left'},
       ...
       var $ = layui.$, active = {
    		  ...
    		  table.on('tool(email_list)', function(obj){
    	           ...
    	           var content="./Authorization_edit_other.jsp?auth_id="+data.auth_id;
