...
<html>
  ...
  <head>
    <meta charset="UTF-8">
    <title>TrunkInfoMtp_edit页面</title>
...
//   			 alert(JSON.stringify(jsonStr));
        	   $.ajax({
        		  url:"${pageContext.request.contextPath}/timtp_updateTrunkInfoMtp.action",
        		  type:"post",
        		  data:"jsonStr="+JSON.stringify(jsonStr),
        		  dataType:"json",
        		  success:function(result){
        		        layer.msg("更新线路成功", {icon: 6,time:1000},function () {
              	            // 获得frame索引
        ...
        function getTrunkInfoMtp(){
			var trunkId='${param.trunkId}';
     	   $.ajax({
     		  url:"${pageContext.request.contextPath}/timtp_getTrunkInfoMtp.action",
     		  type:"post",
     		  data:"trunkId="+trunkId,
     		  dataType:"json",
     		  success:function(result){
//      			 	console.log(result);
     			 	$("#trunkId").val(result.trunkId);
     			 	$("#providerCircuitNum").val(result.providerCircuitNum);
     			 	$("#internalCircuitNum").val(result.internalCircuitNum);
     			 	$("#provider").val(result.provider);
     			 	$("#trunkName").val(result.trunkName);
     			 	$("#aEndFullName").val(result.AEndFullName);
     			 	$("#zEndFullName").val(result.ZEndFullName);
     			 	$("#aEndInterface").val(result.AEndInterface);
     			 	$("#zEndInterface").val(result.ZEndInterface);
     			 	$("#aEndInterfaceIp").val(result.AEndInterfaceIp);
     			 	$("#zEndInterfaceIp").val(result.ZEndInterfaceIp);
     			 	$("#linkType").val(result.linkType);
     			 	$("#createTime").val(result.createTime);
     			 	$("#lastUpdatedTime").val(result.lastUpdatedTime);
     		  } 
     	  	});  
        }
