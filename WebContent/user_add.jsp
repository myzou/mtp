    	 ...
    	 layui.form.render ();   
          ...
          form.on('submit(add)', function(data){
        	  ...
        	  json.roles=getRolesChecked();
        	   ...
        	   $.ajax({
        		  url:"${pageContext.request.contextPath}/user_addSysUser.action",
        		  type:"post",
        		  data:"jsonStr="+JSON.stringify(json),
        		  dataType:"json",
        		  success:function(result){
        		        layer.msg("增加用户成功", {icon: 6,time:1000},function () {
              	            // 获得frame索引
                 		   ...
                 		   $.ajax({
                 	     		  ...
                 	     		  success:function(result){
                 	     	         	...
                 	     	         	for(var i in groupCheckbox){
                 	     	         		 for( var s in result){
                 		     	         		if(	result[s].role_id==groupCheckbox[i].value){
