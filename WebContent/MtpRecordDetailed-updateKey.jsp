         ...
         <div class="layui-form-item">
          ...
          <label for="popName" class="layui-form-label">
             ...
             <div class="layui-input-inline" >
				 	<input type="text" id="op_name"	 name="op_name"  placeholder="请输入op帐号" autocomplete=“off”  class="layui-input" >
  			</div>
             ...
             <div class="layui-input-inline" >
				 	<input type="password" id="op_password"	 name="op_password"  placeholder="请输入op密码"  autocomplete="off"    class="layui-input" >
  			</div>
  			
  			  	 <button class="layui-btn"   onclick="updateKey()"	type="button"   title="修改OP帐号密码"><i class="layui-icon">&#xe614;</i></button>
		</div>
...
//         		  some code
      ...
      function  updateKey(){
    	  ...
    	  if(op_name==""||op_password==""){
				alert("帐号或者密码不能为空");
				return false;
			}
    	  layer.confirm('是否修改帐号密码?', {
              btn: ['修改','取消'] //按钮
          }, function(){
