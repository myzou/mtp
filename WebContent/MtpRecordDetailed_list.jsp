     ...
     <div class="x-body"> 
      ...
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
            ...
            <input type="hidden"  id="show_type"  name="show_type"  value="trunk_" />
...
// 				 {field:'mtp_record_detailed_uuid',  title: 'mtp_record_detailed_uuid',align: 'center'   ,width: 100  ,hide:true }
    	       ...
    	       ,{field:'endFullName',  title: 'end_full_name',align: 'center'  ,width:130 }
    	       ,{field:'endInterface',  title: 'end_interface',align: 'center'  ,width:100  }
    	       ,{field:'providerCircuitNum',  title: 'provider_circuit_num',align: 'center'   ,width:80  }
    	       ...
    	       ,{field:'deviceIp',  title: 'device_ip',align: 'center'  ,width:160  }
...
//     	      ,{field:'status', title: '状态', width:177,align: 'center',toolbar:"#barDemo"}
  	    	  ...
  	    	  $("[data-field = 'beforeStatus']").children().each(function(){//根据对应的字段值进行显示内容
  	    	    if($(this).text() == 'fail'){
  	    	      $(this).parent().css('background-color', '#ea9999');//设置css
  	    	    } 
  	    	  });
...
//     	            return false;
			    	            if(obj.event === 'freshen'){
			    	            	  $.ajax({
			    	            		  url:"${pageContext.request.contextPath}/mtprd_updateMtpRecordDetailed.action",
			    	            		  type:"post",
			    	            		  data:"jsonStr="+JSON.stringify(data),
			    	            		  dataType:"json",
			    	            		  success:function(result){
...
// 	  	            	str=str+"操作类型:"+data.ins_type+"<br>";
  ...
  function caseAdd(){
      var content="./MtpRecordDetailed_add.jsp";
